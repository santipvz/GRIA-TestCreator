...
def examWriter(questions, fileOutName, style):
    ...
    with open(style, "r", encoding="utf-8") as styleFile, \
        open("./scripts/submitFormFunction.js", "r", encoding="utf-8") as submitFormFile, \
        open("./scripts/singleChoiceFunction.js", "r", encoding="utf-8") as singleChoiceFile, \
        open("./scripts/multipleChoiceFunction.js", "r", encoding="utf-8") as multipleChoiceFile:
